...
<form method="POST" action="{{ route('employees.store') }}">
    ...
    <div class="mb-3">
        <label>CPF</label>
        <input id="cpf" type="text" name="cpf" class="form-control" value="{{ old('cpf') }}" required>
    </div>
    ...
    <div class="mb-3">
        <label>CEP</label>
        <input id="cep" type="text" name="cep" class="form-control" value="{{ old('cep') }}" required>
    </div>
    ...
    <div class="mb-3">
        <label>Bairro</label>
        <input id="neighborhood" type="text" name="neighborhood" class="form-control" value="{{ old('neighborhood') }}">
    </div>
